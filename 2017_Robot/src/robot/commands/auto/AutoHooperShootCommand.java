 ...
 */
public class AutoHooperShootCommand extends Command {

	private final double shooterSpeed;
	private final int    shooterAngleAdjustSetpoint;
	private final double timeout;
	
	public AutoHooperShootCommand(double shooterSpeed, int shooterAngleAdjustSetpoint, double timeout) {
	...
	protected void initialize() {
		...
		if (target != null) {
			...
			double shooterSpeed = 0.2 * distance + 44;
