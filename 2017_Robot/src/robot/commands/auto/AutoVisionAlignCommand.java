...
public class AutoVisionAlignCommand extends Command {
	...
	private enum Step {PAUSE, CALCULATE, ALIGN, DONE};
	 ...
	 * @param visionDistance CLOSE or FAR
	 */
	 ...
	 * The command ends when the robot is aligned with the target.
	 * @param visionDistance CLOSE or FAR
	 * @param timeout before the command ends if alignment is not complete
	 */
